	...
	do {
		...
		switch (nSelection)
		{
			case 1: //note the colon not the semicolon 
				...
				if (!OnCheckDimForAddition(nRowsMatrixA, nColsMatrixA, nRowsMatrixB, nColsMatrixC, &nRowsMatrixC, &nColsMatrixC))
				{
					continue; 
				}
			...
			case 2:
				...
				if (!OnCheckDimForMultiplication(nRowsMatrixA, nColsMatrixA, nRowsMatrixB, nColsMatrixC, &nRowsMatrixC, &nColsMatrixC))
				{
					continue;
				}
				OnGetMatrix("A", MatrixA, nRowsMatrixA, nColsMatrixA);
