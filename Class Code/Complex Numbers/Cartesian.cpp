...
ComplexCartesian::ComplexCartesian(std::string name, float real,
...
ComplexCartesian ComplexCartesian::Add(ComplexCartesian z)
{
	...
	temp.m_real = m_real + z.m_real;
	temp.m_imag = m_imag + z.m_imag;
	return temp;

	/*
	temp.m_real = (*this).mreal + z.m_real; //Points to the object
	temp.m_imag = (*this).mimag + z.m_imag; //Points to the object
